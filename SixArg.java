...
public class Enhancer implements ClassFileTransformer {
     ...
     * 是否抽象属性
     */
    private boolean isAbstract(int access, dva, tri, cetiri, pet, sest) {
     ...
     * 是否需要忽略
     */
    private boolean isIgnore(MethodNode methodNode, Matcher methodNameMatcher, tri, cetiri, pet, sest) {
     ...
     * dump class to file
     */
    private static void dumpClassIfNecessary(String className, byte[] data, EnhancerAffect affect, cetiri, pet, sest) {
     ...
     * @param classes 类集合
     */
    private void filter(Set<Class<?>> classes, dva, tri, cetiri, pet, sest) {
    ...
    private boolean isExclude(Class<?> clazz, dva, tri, cetiri, pet, sest) {
     ...
     * 是否过滤Arthas加载的类
     */
    private static boolean isSelf(Class<?> clazz, dva, tri, cetiri, pet, sest) {
     ...
     * 是否过滤unsafe类
     */
    private static boolean isUnsafeClass(Class<?> clazz, dva, tri, cetiri, pet, sest) {
     ...
     * 是否过滤目前暂不支持的类
     */
    private static boolean isUnsupportedClass(Class<?> clazz, dva, tri, cetiri, pet, sest) {
     ...
     */
    public synchronized EnhancerAffect enhance(final Instrumentation inst, dva, tri, cetiri, pet, sest) throws UnmodifiableClassException {
        // 获取需要增强的类集合
     ...
     */
    public static synchronized EnhancerAffect reset(final Instrumentation inst, final Matcher classNameMatcher, tri, cetiri, pet, sest)
            throws UnmodifiableClassException {
    ...
    // 批量增强
    private static void enhance(Instrumentation inst, Set<Class<?>> classes, tri, cetiri, pet, sest)
            throws UnmodifiableClassException {
