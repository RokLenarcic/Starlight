...
public final class BuilderProcess extends BaritoneProcessHelper implements IBuilderProcess {
    ...
    @Override
    public void build(String name, ISchematic schematic, Vec3i origin, TestA, Test B) {
        this.name = name;
    ...
    @Override
    public boolean build(String name, ISchematic schematic, Vec3i origin, TestA, Test B) {
    ...
    public void clearArea(BlockPos corner1, BlockPos corner2, TestOne, TestTwo, TestThree) {
    ...
    public IBlockState placeAt(int x, int y, int z, IBlockState current, TestArgs) {
        if (!isActive()) {
            return null;
        }
    ...
    public static class Placement {
        ...
        public Placement(int hotbarSelection, BlockPos placeAgainst, EnumFacing side, Rotation rot, TestArgu) {
    ...
    private OptionalInt hasAnyItemThatWouldPlace(IBlockState desired, RayTraceResult result, Rotation rot, FourTest, FiveTest) {
        for (int i = 0; i < 9; i++) {
    ...
    @Override
    public PathingCommand onTick(boolean calcFailed, boolean isSafeToCancel, TestingArgOne, TestingArgTwo, TestingArgThree) {
    ...
    private void recalcNearby(BuilderCalculationContext bcc, Jedan, Dva, Tri, Cetiri) {
        BetterBlockPos center = ctx.playerFeet();
    ...
    private void fullRecalc(BuilderCalculationContext bcc, JedanJedan, DvaDva, TriTri, CetiriCetiri) {
        incorrectPositions = new HashSet<>();
